...
/*
Описание
Отобрать среди всех сделок с клиентами тех кто купил в рамках одной сделки более чем на 27000 и вывести
id сделки, дату сделки, имя продавца, сумму всей сделки и сумму на котороую клиент купил всех товаров в рамках 1 заказа.
*/
...
4) (Опциональный) Переписать с меньшим кол-вом join, а больше с in/exist
*/
